...
const Hero = () => {
  return (
    <div className="w-full bg-black text-white selection:bg-white/30">
      ...
      <section className="relative h-screen w-full overflow-hidden bg-black">
        ...
        <div className="relative h-full w-full pointer-events-none">
          ...
          {/* Description */}
          <p className="absolute left-6 md:left-10 top-[46%] max-w-[240px] text-[15px] leading-snug text-white/90 lowercase pointer-events-auto">
          ...
          <div className="absolute right-6 md:right-24 top-[12%] md:top-[14%]">
            <div className="flex items-center gap-3 justify-end">
              ...
              <span className="text-3xl md:text-5xl font-medium tracking-tight text-white">+10k</span>
            </div>
          ...
          <div className="absolute left-6 md:left-20 bottom-32 md:bottom-24">
            <div className="flex items-center gap-3">
              <span className="text-3xl md:text-5xl font-medium tracking-tight text-white">+500</span>
              <div className="hidden md:block h-px w-24 bg-white/40 rotate-[-20deg]" />
            </div>
          ...
          <div className="absolute right-6 md:right-20 bottom-12 md:bottom-20">
            <div className="flex items-center gap-3 justify-end">
              <div className="hidden md:block h-px w-24 bg-white/40 rotate-[-20deg]" />
              <span className="text-3xl md:text-5xl font-medium tracking-tight text-white">+50</span>
            </div>
            <div className="text-xs md:text-sm text-white/70 mt-1 text-right lowercase">
              community events
            </div>
      ...
      {/* 2. Marquee Section */}
      <section className="py-20 bg-neutral-950 border-y border-white/5 overflow-hidden flex whitespace-nowrap">
        <div className="animate-marquee flex gap-12 items-center">
          {Array(4).fill(["✨ belong", "listen", "connect", "humans", "stories", "presence"]).flat().map((word, i) => (
            <span key={i} className="text-3xl md:text-5xl font-medium text-white/40 lowercase inline-block">
              {word} <span className="mx-8 text-white/10">•</span>
            </span>
          ))}
        </div>
      </section>
      ...
      <section className="py-32 px-6 md:px-10 max-w-7xl mx-auto">
        <div className="mb-20 max-w-2xl">
          ...
          <p className="text-xl text-white/60 lowercase leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-neutral-900/40 border border-white/10 p-10 rounded-3xl hover:bg-neutral-900 transition-colors">
            <div className="h-12 w-12 rounded-full bg-white/10 flex items-center justify-center mb-10">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"></path></svg>
            </div>
            <h3 className="text-2xl font-medium mb-4 lowercase">active listening</h3>
            <p className="text-white/60 lowercase leading-relaxed">
          ...
          <div className="bg-neutral-900/40 border border-white/10 p-10 rounded-3xl hover:bg-neutral-900 transition-colors">
            <div className="h-12 w-12 rounded-full bg-white/10 flex items-center justify-center mb-10">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
            </div>
      ...
      {/* 4. Final CTA */}
      <section className="py-32 px-6 md:px-10 text-center flex flex-col items-center justify-center border-t border-white/5 bg-gradient-to-t from-neutral-950 to-black">
        <h2 className="hero-title text-6xl md:text-8xl font-medium lowercase mb-8">
          your story matters.
        </h2>
        <p className="text-xl text-white/60 lowercase max-w-xl mb-12">
        ...
        <button 
          ...
          className="bg-white text-black text-lg font-medium rounded-full px-10 py-5 hover:scale-105 transition-transform lowercase"
        >
          become a member
        </button>
      </section>
