...
const Footer = () => {
  ...
  return (
    <footer className="w-full relative overflow-hidden mt-auto border-t border-[#2b2622]/8 text-[#2b2622] bg-[#fbf8f5]">
      ...
      <div className="max-w-7xl mx-auto pt-4 sm:pt-5 pb-2.5 px-6 md:px-12 lg:px-16 relative z-10 flex flex-col justify-between">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-2 sm:gap-4 items-center">
          ...
          <div className="md:col-span-5 flex flex-col items-start text-left pl-0 md:pl-28 lg:pl-32">
            <h2 className="font-['Caveat'] text-[#8c3a3a] text-2xl sm:text-3xl lg:text-[30px] font-bold leading-tight mb-0.5 tracking-tight">
              For the community,<br />
              by the community. <span className="inline-block text-lg lg:text-xl font-normal">♡</span>
            </h2>
          </div>

          {/* Center Column: Nizhal Logo Seal */}
          <div className="md:col-span-2 flex flex-col items-center justify-center -mt-1 sm:-mt-2">
            <Link to="/" className="group flex flex-col items-center cursor-pointer">
              {/* Circular Logo Frame */}
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full border-2 sm:border-[3px] border-[#cda2a2] bg-[#f5e6e6]/95 p-0.5 sm:p-1 flex items-center justify-center shadow-sm shadow-[#2b2622]/10 transition-transform duration-300 group-hover:scale-105 overflow-hidden backdrop-blur-sm">
                <img 
                  src={logoUrl} 
          ...
          <div className="md:col-span-5 flex flex-col items-start md:items-end text-left md:text-right pr-0 md:pr-16 lg:pr-24">
            <h3 className="font-['Caveat'] text-[#8c3a3a] text-2xl sm:text-3xl font-bold mb-1 tracking-tight">
              Stay Connected <span className="inline-block font-normal text-lg">♡</span>
            </h3>
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="w-6 h-6 rounded-full bg-[#2b2622] text-white flex items-center justify-center hover:bg-[#522D21] transition-colors shadow-sm"
            ...
            <p className="text-[11px] text-[#2b2622]/75 lowercase leading-snug max-w-xs">
        ...
        <div className="w-full pt-2 pb-1 border-t border-[#2b2622]/8 flex flex-col sm:flex-row items-center justify-between gap-1 text-[11px] text-[#2b2622]/50 lowercase relative z-10 mt-2.5">
          <span>
            © {currentYear} nizhal – circle of warmth. all rights reserved.
          </span>
          <div className="flex items-center gap-1 text-[#2b2622]/60">
            <span>made with</span>
            <span className="text-[#8c3a3a] text-xs">♥</span>
