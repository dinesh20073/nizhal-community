...
const Footer = () => {
  ...
  return (
    <footer className="w-full relative overflow-hidden mt-auto border-t border-[#2b2622]/8 text-[#2b2622] bg-[#fdf9f7]">
      {/* Exact Background Image Layer */}
      <div className="absolute inset-0 w-full h-full pointer-events-none select-none z-0">
        <img 
          src={footerBgUrl} 
          alt="Nizhal Footer Background" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="md:col-span-2 flex flex-col items-center justify-center py-2 md:py-0">
            <Link to="/" className="group flex flex-col items-center cursor-pointer">
              {/* Circular Logo Frame */}
              <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-[#cda2a2] bg-[#f5e6e6]/80 p-1 flex items-center justify-center shadow-md shadow-[#2b2622]/5 transition-transform duration-300 group-hover:scale-105 overflow-hidden backdrop-blur-sm">
                <img 
                  src={logoUrl} 
              ...
              {/* Decorative Ribbon & Warmth Text */}
              <div className="flex flex-col items-center -mt-1">
                <svg width="34" height="14" viewBox="0 0 36 16" fill="none">
          ...
          <div className="md:col-span-5 flex flex-col items-start md:items-end text-left md:text-right">
            ...
            <p className="text-xs text-[#2b2622]/75 lowercase leading-relaxed max-w-xs mb-2">
              follow our journey and be a part of the circle of warmth!
            </p>

            {/* Community Friends Illustration right on the dotted line */}
            <div className="w-full max-w-[190px] sm:max-w-[220px] ml-auto">
              <img 
      ...
      <div className="max-w-7xl mx-auto pt-3 pb-2 border-t border-[#2b2622]/8 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-[#2b2622]/50 lowercase relative z-10">
        <span>
