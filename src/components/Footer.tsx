...
const Footer = () => {
  ...
  return (
    <footer className="w-full relative overflow-hidden mt-auto border-t border-[#2b2622]/8 text-[#2b2622] bg-[#faf6f3]">
      {/* Exact Unstretched Background Image */}
      ...
      {/* Main Footer Content Layer */}
      <div className="max-w-7xl mx-auto pt-10 sm:pt-12 pb-4 px-6 md:px-12 lg:px-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-10 items-center">
          
          {/* 1. Left Column: Tagline & Subtitle */}
          <div className="md:col-span-5 flex flex-col items-start text-left">
            ...
            <p className="text-xs sm:text-sm text-[#2b2622]/75 lowercase leading-relaxed max-w-sm mb-4">
              together we create a circle of warmth, kindness, and belonging.
            </p>
          </div>

          {/* 2. Center Column: Nizhal Logo Seal */}
          <div className="md:col-span-2 flex flex-col items-center justify-center py-2 md:py-0">
            <Link to="/" className="group flex flex-col items-center cursor-pointer">
              ...
              {/* Decorative Ribbon Loop & Warmth Label */}
          ...
          <div className="md:col-span-5 flex flex-col items-start md:items-end text-left md:text-right">
            ...
            <p className="text-xs text-[#2b2622]/75 lowercase leading-relaxed max-w-xs mb-1.5">
              follow our journey and be a part of the circle of warmth!
            </p>

            {/* Community Friends Illustration */}
            <div className="w-full max-w-[170px] sm:max-w-[200px] ml-auto">
              <img 
      ...
      <div className="max-w-7xl mx-auto pt-2.5 pb-2 border-t border-[#2b2622]/8 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-[#2b2622]/50 lowercase relative z-10">
        <span>
