...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#fcfaf8] border-t border-[#2b2622]/8 text-[#2b2622] relative overflow-hidden mt-auto pt-8 pb-4 px-6 md:px-12 lg:px-16">
      {/* Main Content Grid - Compact & Clean */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-center relative z-10">
        
        {/* Left Column: Community Message & Hands Image */}
        <div className="md:col-span-5 flex flex-col items-start text-left">
          <h2 className="font-['Caveat'] text-[#8c3a3a] text-3xl sm:text-4xl font-bold leading-tight mb-1.5 tracking-tight">
            For the community,<br />
            by the community. <span className="inline-block text-2xl font-normal">♡</span>
          </h2>
          <p className="text-xs sm:text-sm text-[#2b2622]/70 lowercase leading-relaxed max-w-sm mb-2">
            together we create a circle of warmth, kindness, and belonging.
          </p>

          {/* User's Uploaded Community Hands Illustration (Full Crisp Size) */}
        ...
        <div className="md:col-span-5 flex flex-col items-start md:items-end text-left md:text-right">
          <h3 className="font-['Caveat'] text-[#8c3a3a] text-3xl sm:text-4xl font-bold mb-1.5 tracking-tight">
          ...
          <p className="text-xs text-[#2b2622]/70 lowercase leading-relaxed max-w-xs mb-2">
            follow our journey and be a part of the circle of warmth!
          </p>

          {/* User's Uploaded Community Friends Illustration (Full Crisp Size) */}
      ...
      {/* Bottom Sub-footer Copyright Bar with integrated subtle dashed divider */}
      <div className="max-w-7xl mx-auto mt-4 pt-3 border-t border-dashed border-[#d8a4a4]/60 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-[#2b2622]/50 lowercase">
        <span>
