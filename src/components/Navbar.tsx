        ...
        {isOpen && (
          ...
          >
            ...
            <motion.button 
              ...
              className="mt-8 bg-[#ff5a1f] text-white text-lg font-medium rounded-full px-10 py-4 active:scale-95 transition-transform duration-300 lowercase shadow-xl shadow-[#2b2622]/10"
            >
              join community
            </motion.button>
          </motion.div>
