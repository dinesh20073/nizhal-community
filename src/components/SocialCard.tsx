...
const SocialCard = () => {
  return (
    <div className="w-fit h-fit bg-transparent flex items-center justify-center gap-2.5">
      {/* Instagram */}
      <motion.a 
        ...
        whileTap={{ scale: 0.9 }}
        className="w-8 h-8 bg-[#2b2622] flex items-center justify-center overflow-hidden transition-colors duration-300 rounded-full hover:bg-[#d62976] active:bg-[#d62976] shadow-sm group cursor-pointer"
        aria-label="Instagram"
      >
        <svg className="w-3.5 h-3.5 group-hover:animate-slide-in-top group-active:animate-slide-in-top" viewBox="0 0 16 16">
      ...
      <motion.a 
        ...
        whileHover={{ y: -3, scale: 1.12 }}
        whileTap={{ scale: 0.9 }}
        className="w-8 h-8 bg-[#2b2622] flex items-center justify-center overflow-hidden transition-colors duration-300 rounded-full hover:bg-[#25D366] active:bg-[#25D366] shadow-sm group cursor-pointer"
        aria-label="WhatsApp"
      >
        <svg className="w-3.5 h-3.5 group-hover:animate-slide-in-top group-active:animate-slide-in-top" viewBox="0 0 16 16">
