const About = () => {
  return (
    <section className="relative min-h-screen w-full bg-white pt-32 px-6 md:px-10 text-black">
      <div className="max-w-4xl mx-auto mt-20">
        <h1 className="hero-title font-medium text-6xl md:text-8xl mb-12 lowercase">
          about us
        </h1>
        <p className="text-xl md:text-2xl text-black/80 lowercase max-w-2xl mx-auto leading-relaxed">
          nizhal community is a quiet space beside you. we believe in the power of genuine human connection and listening.
        </p>
        <p className="text-lg text-black/60 lowercase leading-relaxed">
